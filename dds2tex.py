...
#   dds2tex.py -i [$uploadedDDS].dds -o mentahan.tex
# 
# Optional (!REQUIRED!):
#   -c | --compress
#       Zlib compress the texture data
#   dds2tex.py -i [$uploadedDDS].dds -o mentahan.tex -c

# Written by Edness    v1.4
# 2022-06-22  -  2022-06-24
# Edited by Ateris 2025-06-30 - 10:58 [Localhost w/ shell_exec() python]
